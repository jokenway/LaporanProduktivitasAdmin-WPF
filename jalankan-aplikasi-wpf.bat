@echo off
title Laporan Produktivitas Admin (WPF .NET 10 Desktop)
color 0B

echo ========================================================
echo   LAPORAN PRODUKTIVITAS ADMIN - NATIVE WPF .NET 10
echo ========================================================
echo.
...
if exist "LaporanProduktivitasWPF\bin\Release\standalone\LaporanProduktivitasAdmin.exe" (
    echo Membuka aplikasi Standalone Desktop Native WPF .NET 10...
...
if exist "LaporanProduktivitasWPF\bin\Release\net10.0-windows\LaporanProduktivitasAdmin.exe" (
    echo Membuka aplikasi Desktop Native WPF .NET 10...
    start "" "LaporanProduktivitasWPF\bin\Release\net10.0-windows\LaporanProduktivitasAdmin.exe"
    exit /b 0
)

echo [INFO] Mengompilasi aplikasi WPF .NET 10...
